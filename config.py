...
ROLE_TEMPLATES = {
    "25": [
        ...
        {"key": "bandeira", "label": "Bandeira", "emoji": "🚩", "capacity": 1, "required_role": "PP-Bandeira"},
        ...
        {"key": "hwatcha", "label": "Hwacha", "emoji": "💀", "capacity": 1, "required_role": "PP-Hwacha"},
        {"key": "shai", "label": "Shai", "emoji": "🎵", "capacity": 2, "required_role": "PP-Shai"},
        {"key": "ranged", "label": "Ranged", "emoji": "🏹", "capacity": 6, "required_role": "PP-Ranged"},
        {"key": "ataque", "label": "Ataque", "emoji": "⚔️", "capacity": 6, "required_role": "PP-Ataque"},
        {"key": "liao", "label": "Lião", "emoji": "🦁", "capacity": 2, "required_role": "PP-Especial"},
    ...
    "30": [
        ...
        {"key": "hwatcha", "label": "Hwacha", "emoji": "💀", "capacity": 1, "required_role": "PP-Hwacha"},
        {"key": "shai", "label": "Shai", "emoji": "🎵", "capacity": 2, "required_role": "PP-Shai"},
        {"key": "ranged", "label": "Ranged", "emoji": "🏹", "capacity": 7, "required_role": "PP-Ranged"},
